const lambda = require('../../../src/handlers/calculate-resolutions.js');

// This includes all tests for calculateResolutionsHandler
describe('Test calculateResolutionsHandler', () => {
    let getSpy;
